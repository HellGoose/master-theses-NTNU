...
\documentclass[MIT, english, DAIM, b5paper, twoside]{ntnuthesis/ntnuthesis}
...
\include{inc/1-introduction}
\include{inc/2-background} % includes latex files from the same directory
%\include{inc/3-theory}
\include{inc/4-methodology} % could be called Methodology or methods or any filename 
 % \include{inc/results} % could be results
\include{inc/5-phase1}
\include{inc/5-phase2}
\include{inc/5-phase3}
\include{inc/6-conclusion}
