\chapter{Phase 2}
    ...
    \com{Should be explained much better how the requirements are derived from the EiT learning goals, the need for facilitating and theory, e.g. immersion and social presence}
        ...
        \begin{enumerate}
            ...
            \item The space must function as a collaborative space, e.g not be too fancy or captivating.  \com{"supporting sense of presence?"}
        ...
        \begin{enumerate}
            \item The avatar should follow the movement of the player. \com{Identity? Social presence}
