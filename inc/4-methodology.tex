...
This chapter will contain the research questions and the description of the methods used to develop and evaluate the application.
    ...
    \begin{center}
        \begin{tabular}{ p{1cm} p{1.2cm} p{10cm} }
            \textbf{\large{RQ1}} & \multicolumn{2}{ c }{How to use mixed- and virtual reality to support and facilitate collaborative learning in the context of project-based learning?} \\
            \\
